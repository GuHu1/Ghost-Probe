...
This was filter/'s own independent occlusion-shadow-zone implementation:
...
filter/osz_source.py instead — see that file's module docstring for why
...
truth for "what is occluded", so filter/ now consumes it directly rather
